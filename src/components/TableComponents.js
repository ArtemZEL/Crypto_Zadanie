          ...
          <tbody>
            {cryptoData.map((data) => {
              return (
                ...
                >
                  <td className="cruptot ">
                    <button className="starplus">
                      <svg
                        className="star"
                        width="30"
                        height="30"
                    ...
                    <span style={{marginLeft:"0.1rem"}}>{data.symbol}</span>

                  </td>
                  <td className="cruptot">{data.name}</td>
                  <td className="cruptot">{
                  ...
                  <td className="cruptot">{Number(data.marketCapUsd).toFixed(2)}</td>
                  <td className="cruptot">{Number(data.volumeUsd24Hr).toFixed(2)}%</td>
                  <td className={data.vwap24Hr>0 ? "text-green py-4" : 'text-red py-4'}
                  >{Number(data.vwap24Hr).toFixed(2)}</td>
                </tr>
              );
            })}
          </tbody>
